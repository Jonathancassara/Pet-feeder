...
const int stepsPerRevolution = 400;  // definit le nombre de pas du moteur 
const int AvanceFood = stepsPerRevolution/1; // defini le nombre de pas pour avancer la nourriture
const int ReculeFood = AvanceFood/4; // defini le nombre de pas pour reculer la nourriture
int QuantiteMatin = 10; // quantite de tour de vis le Matin
int doseMultiply = 1; //
int SpeedRemplissage = 150; // vitesse de rotation de la vis
int hasBeenFeed = 0;
